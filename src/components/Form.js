    ...
    <form className="form" onSubmit={props.handleSubmit}>
      ...
      <fieldset>
        ...
        <select
          ...
          onChange={props.handleFormChange}
          value={props.questionsDifficulty}
          required
        >
          <option value="">Choose...</option>
      ...
      <button className="btn start--button" type="submit">
        Start Quiz
      </button>
    </form>
  );
